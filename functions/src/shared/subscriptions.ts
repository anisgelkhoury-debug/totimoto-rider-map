...
export function selectEnabledSubscriptions(
  ...
  for (const doc of docs) {
    ...
    if (!prefs || prefs[preferenceKey] !== true) continue
...
/** @deprecated Prefer selectEnabledSubscriptions(..., "helperLifecycle") */
export function selectEnabledHelperLifecycleSubscriptions(
  docs: SubscriptionDoc[],
  ownerUid: string
): SelectedSubscription[] {
  return selectEnabledSubscriptions(docs, ownerUid, "helperLifecycle")
}
